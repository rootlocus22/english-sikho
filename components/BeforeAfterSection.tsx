            ...
            <div className="container mx-auto px-4 max-w-6xl">
                ...
                <div className="space-y-6 md:space-y-8">
                    {examples.map((example, i) => (
                        <Card key={i} className="p-4 sm:p-6 md:p-8 border-2 border-slate-200">
                            ...
                            <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                                ...
                                <div className="bg-red-50 border-2 border-red-200 rounded-xl p-4 sm:p-6">
                                    <div className="flex items-center gap-2 mb-3 sm:mb-4">
                                        ...
                                        <h4 className="font-bold text-sm sm:text-base text-red-900">Before EnglishGyani</h4>
                                    </div>
                                    <div className="bg-white rounded-lg p-3 sm:p-4 mb-3 sm:mb-4 border border-red-200">
                                        <p className="text-xs sm:text-sm text-slate-700 italic break-words">"{example.before.text}"</p>
                                    </div>
                                    <div className="space-y-2">
                                        {example.before.issues.map((issue, j) => (
                                            <div key={j} className="flex items-start gap-2 text-xs sm:text-sm text-red-700">
                                                <X className="w-3 h-3 sm:w-4 sm:h-4 text-red-600 shrink-0 mt-0.5" />
                                ...
                                <div className="bg-green-50 border-2 border-green-200 rounded-xl p-4 sm:p-6">
                                    <div className="flex items-center gap-2 mb-3 sm:mb-4">
                                        ...
                                        <h4 className="font-bold text-sm sm:text-base text-green-900">After EnglishGyani</h4>
                                    </div>
                                    <div className="bg-white rounded-lg p-3 sm:p-4 mb-3 sm:mb-4 border border-green-200">
                                        <p className="text-xs sm:text-sm text-slate-700 break-words">"{example.after.text}"</p>
                                    </div>
                                    <div className="space-y-2">
                                        {example.after.improvements.map((improvement, j) => (
                                            <div key={j} className="flex items-start gap-2 text-xs sm:text-sm text-green-700">
                                                <Check className="w-3 h-3 sm:w-4 sm:h-4 text-green-600 shrink-0 mt-0.5" />
