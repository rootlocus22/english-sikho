 ...
 */
export async function generateWithFallback(prompt: string | Array<string | any>, options: GenerateOptions = {}) {
    const {
        maxOutputTokens = 1000, // Increased from 250 to prevent JSON truncation
        temperature = 0.7,
 ...
 */
export async function generateWithRetry(prompt: string | Array<string | any>, options: GenerateOptions = {}) {
    const {
        maxRetries = 2,
        retryDelay = 1000,
        ...fallbackOptions
 ...
 */
export async function generateContent(prompt: string | Array<string | any>, options: GenerateOptions = {}) {
 ...
 */
export function isOverloadError(error: any) {
    const errorMessage = error.message?.toLowerCase() || '';
